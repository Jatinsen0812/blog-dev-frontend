...
function Setting() {
  ...
  return token == null ? (
    ...
    <div className="w-full p-5 md:w-[800px] flex flex-col items-center h-[calc(100vh_-_150px)] mx-auto">
      <div className="w-full">
        <h1 className=" my-2 text-2xl font-semibold text-left">Settings</h1>
      </div>

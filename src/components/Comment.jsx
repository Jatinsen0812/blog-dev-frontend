...
function Comment() {
  ...
  return (
    <div className="bg-white h-screen p-5 mt-15 fixed top-0 right-0 w-[400px] border-l drop-shadow-xl overflow-y-scroll">
      ...
      <div className="my-4">
        <textarea
          ...
          type="text"
          placeholder="Comment..."
          className=" h-[150px] resize-none drop-shadow w-full p-3 text-lg focus:outline-none border rounded-lg"
          onChange={(e) => setComment(e.target.value)}
        />
        <button onClick={handleComment} className="bg-green-500 text-white text-xl font-medium cursor-pointer rounded-lg px-5 py-2 my-2">
          Add
        </button>
      </div>
              ...
              <div className="my-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="bg-red-500 px-7 py-3 my-2 rounded-3xl cursor-pointer "
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="bg-green-500 px-7 py-3 my-2 rounded-3xl cursor-pointer "
                  >
                    Edit
                  </button>
                </div>
                    ...
                    currentPopup == comment?._id ? (
                      <div className="bg-gray-200 w-[70px] rounded-lg">
                        ...
                        {comment.user._id === userId ? (
                          <p
                            className="p-2 py-1 hover:bg-blue-400 cursor-pointer"
                            onClick={() => {
                        ...
                        <p
                          className="p-2 py-1 hover:bg-blue-400 cursor-pointer rounded-b-lg"
                          onClick={() => {
            ...
            {activeReply === comment._id && (
              <div className="my-4">
                ...
                <button
                  ...
                  className="bg-green-500 text-xl text-white font-medium rounded-lg px-5 py-2 my-2"
                >
                  Add
                </button>
              </div>

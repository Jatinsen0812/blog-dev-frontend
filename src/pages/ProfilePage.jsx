      ...
      {userData ? (
        <div className="w-[80%] flex max-lg:flex-col-reverse justify-evenly ">
          <div className=" max-lg:w-full w-[50%] ">
            <div className="hidden sm:flex justify-between my-7">
          ...
          <div className=" max-lg:w-full w-[20%]   lg:border-l max-lg:flex lg:pl-10 lg:min-h-[calc(100vh_-_70px)] ">
            <div className="my-8">
              ...
              <p className="text-xl max-md:text-lg font-medium my-1">
                {userData?.name}
              </p>
              <p className="text-base">{userData.followers.length} Followers</p>
              ...
              {userId === userData._id ? (
                <button className="bg-green-600 px-7 py-3  max-lg:w-full rounded-full text-white mt-3">
                ...
                <button
                  ...
                  className="bg-green-600 px-7 py-3 rounded-full max-lg:w-full text-white mt-3"
                >

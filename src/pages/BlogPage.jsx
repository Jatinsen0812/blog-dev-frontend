...
function BlogPage() {
  ...
  return (
    <div className="max-w-[700px] mx-auto p-5 ">
      {blogData ? (
        <div>
          <h1 className="mt-5 font-bold text-2xl  sm:text-3xl lg:text-4xl capitalize">
            {blogData.title}
          </h1>
          ...
          <div className="flex items-center my-5 gap-3">
            <Link to={`/@${blogData.creator.username}`}>
              <div>
                <div className="w-12 h-12 cursor-pointer aspect-square rounded-full overflow-hidden">
                  <img
                    src={
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-1 ">
                <Link to={`/@${blogData.creator.username}`}>
                  <h2 className="text-xl font-medium hover:underline cursor-pointer">
                ...
                {userId !== blogData.creator._id && (
                  <p
                    ...
                    className="text-xl font-medium text-green-700 cursor-pointer"
                  >
                    .
          ...
          <img className="rounded-lg" src={blogData.image} alt="" />

          {token && email === blogData.creator.email && (
            <Link to={"/edit/" + blogData.blogId}>
              <button className="bg-green-500 mt-5 cursor-pointer px-6 py-2 text-xl rounded-lg ">
                Edit
              </button>
            </Link>
          )}
          <div className="flex gap-4 mt-4">
            ...
            <div className="flex gap-1 cursor-pointer">
              <i
                ...
                className="fi fi-sr-comment-alt text-3xl mt-1 cursor-pointer"
              ></i>
            ...
            >
              {isBlogSaved ? (
                <i className="fi fi-sr-bookmark text-2xl mt-1"></i>
              ) : (
                <i className="fi fi-rr-bookmark text-2xl mt-1"></i>
              )}
            </div>
          </div>
              ...
              if (block.type == "header") {
                ...
                return (
                  <div className="my-4" key={index}>
                    <img className="rounded-b-xl" src={block.data.file.url} alt="" />

...
function AuthForm({ type }) {
  ...
  return (
    <div className="w-full h-[calc(100vh_-_40px)] flex my-5  p-4 justify-center">
      <div className=" bg-gray-100 p-4 rounded-xl mx-auto w-[400px] h-[500px]  flex flex-col items-center justify-center gap-3 ">
        ...
        >
          ...
          <button className="w-[100px] h-[50px] text-white cursor-pointer text-xl p-2 rounded-2xl focus:outline-none bg-blue-500">
        ...
        {type == "signin" ? (
          ...
          <p>
            Already have an account <Link to={"/signin"}><span className="underline">Sign in</span></Link>
          </p>
        )}
      </div>
    </div>
